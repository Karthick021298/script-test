        ...
        >
          ...
          <div className={classes.card}>
            <Typography variant="h3">
              Reach us on WhatsApp! Start a conversation using the button below
              and we try to reply soon as possible
            </Typography>
          </div>
        </motion.div>
      </Grid>
      ...
      >
        <motion.div whileTap={{ scale: 0.95 }}>
          <Button
            onClick={() =>
              window.open(
                "https://api.whatsapp.com/send/?phone=6580607163&text=Hello!",
                "_blank"
              )
            }
    ...
    <Box>
      ...
      >
        ...
        >
          ...
          <div className={classes.card}>
            <Typography variant="h3">
              Reach us on Facebook! Start a conversation using the button below
      ...
      >
        <motion.div whileTap={{ scale: 0.95 }}>
          <Button
            onClick={() =>
              window.open("https://www.facebook.com/lyfngo.official", "_blank")
            }
