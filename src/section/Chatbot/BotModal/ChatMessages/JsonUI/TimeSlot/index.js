...
const TimeSlot = (props) => {
  ...
  const bookDemo = (selectedSlot, slotData, meetLink) => {
    const body = {
      ...
      plannedProcedure: [],
      notes: "",
      onOff: _.isEqual(bookModes, "at-clinic")
        ? "0"
        : _.isEqual(bookModes, "on-line")
        ? "1"
        : _.isEqual(bookModes, "at-home")
        ? "2"
        : "0",
    ...
    const onFailure = () => {
      ...
      setMessages((prevMessages) => [
        ...prevMessages,
        {
          ...
          component: "",
          data: {
            message: `Internal Error. Try again with the same once ${selectedSlot} or choose other slots from below.`,
          },
        },
        {
          name: "SlotSelection",
