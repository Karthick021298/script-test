import { themeConfig } from '@/src/theme/themesConfig'
					...
					<Avatar
						...
						src={
							domainData?.tentLogoDoc
								...
								? `${process?.env?.NEXT_PUBLIC_IMAGEKIT_URL}/B2B_Flash/Header/Care.svg`
								: `${process?.env?.NEXT_PUBLIC_IMAGEKIT_URL}/B2B_Flash/Header/Non_Care.svg`
						}
					/>
				</motion.div>
			</Grid>
